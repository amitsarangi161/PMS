          ...
          <div class="box box-success">
            ...
            <form method="post" action="/companysetup" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  <label>Website</label>
                  <input type="text" class="form-control" value="{{$websitelink}}"name="website">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  <label>Fax No</label>
                  <input type="text" class="form-control" value="{{$fax}}"name="fax">
                </div>
                <div class="form-group col-md-6">
                  <label>Pan</label>
                  <input type="text" class="form-control" value="{{$pan}}"name="pan">
                </div>
                <div class="form-group col-md-6">
                  <label>GST No</label>
                  <input type="text" class="form-control" value="{{$gst}}"name="gst">
                </div>
                <div class="form-group col-md-6">
                  <label>Address</label>
